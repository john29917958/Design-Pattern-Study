...
{
public:
	attributes_decorator(std::shared_ptr<base_attributes> base_attributes, std::shared_ptr<attributes> attributes);
...
{
public:
	level_decorator(std::shared_ptr<base_attributes> base_attributes, std::shared_ptr<attributes> attributes, int level);
...
{
public:
	fairy_gun_i_decorator(std::shared_ptr<base_attributes> base_attributes, std::shared_ptr<attributes> attributes, int level);
